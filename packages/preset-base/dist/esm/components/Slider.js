...
import { mode, getOrientationStyle } from "./utils";
var Slider = {
    defaultProps: {
        size: "md",
    },
    ...
    baseStyle: function (props) { return ({
        ...
        Thumb: __assign({ zIndex: 1, borderRadius: "full", bg: "white", boxShadow: "sm", border: "1px solid", borderColor: "transparent", transition: "transform 0.2s", _focus: {
                boxShadow: "outline",
            }, _disabled: {
                bg: "gray.300",
            } }, getOrientationStyle({
