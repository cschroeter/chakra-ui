...
export function useCounter(props) {
    ...
    var onChange = props.onChange, precisionProp = props.precision, defaultValue = props.defaultValue, valueProp = props.value, _a = props.step, stepProp = _a === void 0 ? 1 : _a, _b = props.min, min = _b === void 0 ? minSafeInteger : _b, _c = props.max, max = _c === void 0 ? maxSafeInteger : _c, _d = props.keepWithinRange, keepWithinRange = _d === void 0 ? true : _d;
     ...
     */
    var _f = useControllableProp(valueProp, valueState), isControlled = _f[0], value = _f[1];
...
function cast(value, step, precision) {
    ...
    return toPrecision(parse(value), precision !== null && precision !== void 0 ? precision : decimalPlaces);
}
