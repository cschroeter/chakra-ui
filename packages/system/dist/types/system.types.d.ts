...
declare type ColorModeProps = {
    colorMode?: ColorMode;
};
declare type BaseStyle<P> = SystemProps | ((props: P & ThemingProps & ColorModeProps) => SystemProps);
declare type Attrs<T extends As> = PropsOf<T> | ((props: any) => PropsOf<T>);
export declare type ThemingProps = {
    /**
...
export interface ChakraProps extends SystemProps, TruncateProps, ValidHTMLProps, ThemingProps, ApplyProp, LayerStyles {
 ...
 */
export declare type PropsOf<T extends As> = React.ComponentPropsWithRef<T>;
export declare type WithAs<P, T extends As> = P & Omit<PropsOf<T>, "as" | keyof P> & {
    as?: T;
};
/**
 ...
 */
export declare type WithChakra<P> = P extends {
    transition?: any;
} ? P & Omit<ChakraProps, "transition"> : P & ChakraProps;
/**
 ...
 */
declare type RegularComponent<T extends As, P> = (props: WithChakra<PropsOf<T>> & P & {
    as?: As;
}) => JSX.Element;
/**
 ...
 */
declare type ExtensibleComponent<T extends As, P> = <TT extends As = T>(props: WithChakra<WithAs<PropsOf<T>, TT>> & P) => JSX.Element;
declare type Component<T extends As, P> = RegularComponent<T, P> | ExtensibleComponent<T, P>;
export declare type ChakraComponent<T extends As, P = {}> = Component<T, P> & {
    displayName?: string;
 ...
 */
export declare type ExtractThemingProps<T extends {
    components: any;
}, K> = K extends string ? T["components"][K] extends undefined ? undefined : T["components"][K] extends {
    variants: infer V;
