...
var StyledSvg = system_1.chakra("svg", { themeKey: "Icon" });
exports.Icon = React.forwardRef(function (props, ref) {
    var as = props.as, size = props.size, _a = props.boxSize, boxSize = _a === void 0 ? "1em" : _a, viewBox = props.viewBox, _b = props.color, color = _b === void 0 ? "currentColor" : _b, _c = props.role, role = _c === void 0 ? "presentation" : _c, _d = props.focusable, focusable = _d === void 0 ? false : _d, children = props.children, className = props.className, rest = tslib_1.__rest(props, ["as", "size", "boxSize", "viewBox", "color", "role", "focusable", "children", "className"]);
    var _className = utils_1.cx("chakra-icon", className);
    var sharedProps = {
        ref: ref,
    ...
    if (as && typeof as !== "string") {
        return React.createElement(StyledSvg, tslib_1.__assign({ as: as }, sharedProps, rest));
    }
    ...
    return (React.createElement(StyledSvg, tslib_1.__assign({ verticalAlign: "middle", viewBox: _viewBox }, sharedProps, rest), _path));
});
if (utils_1.__DEV__) {
