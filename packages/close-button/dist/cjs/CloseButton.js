 ...
 */
var CloseIcon = function (props) { return (React.createElement(icon_1.Icon, tslib_1.__assign({ focusable: "false", "aria-hidden": true }, props),
...
exports.CloseButton = function (props) {
    var _a = props.children, children = _a === void 0 ? React.createElement(CloseIcon, { width: "1em", height: "1em" }) : _a, isDisabled = props.isDisabled, rest = tslib_1.__rest(props, ["children", "isDisabled"]);
    return (React.createElement(StyledButton, tslib_1.__assign({ disabled: isDisabled }, rest), children));
};
if (utils_1.__DEV__) {
