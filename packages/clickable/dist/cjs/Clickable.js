...
function useClickable(props) {
    ...
    var ref = utils_1.mergeRefs(htmlRef, refCallback);
    if (isButton) {
        return tslib_1.__assign(tslib_1.__assign({}, htmlProps), { ref: ref, type: "button", "aria-disabled": trulyDisabled ? undefined : isDisabled, disabled: trulyDisabled, onClick: handleClick, onMouseDown: onMouseDown,
            onMouseUp: onMouseUp,
            onKeyUp: onKeyUp,
            onKeyDown: onKeyDown,
            onMouseOver: onMouseOver });
    }
    return tslib_1.__assign(tslib_1.__assign({}, htmlProps), { ref: ref, role: "button", "data-active": utils_1.dataAttr(isActive), "aria-disabled": !!isDisabled, tabIndex: trulyDisabled ? undefined : tabIndex, onClick: handleClick, onMouseDown: handleMouseDown, onMouseUp: handleMouseUp, onKeyUp: handleKeyUp, onKeyDown: handleKeyDown, onMouseOver: handleMouseOver });
}
