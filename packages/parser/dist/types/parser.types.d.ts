...
import { SpaceProps, ColorProps, TypographyProps, LayoutProps, FlexboxProps, GridProps, BorderProps, PositionProps, OtherProps, BackgroundProps, ShadowProps, OutlineProps } from "./configs";
import { PseudoProps } from "./pseudo";
declare type Length = string | 0 | number;
export declare type ThemeKey<T, K extends keyof any = keyof any> = T[] | Record<K, T>;
export declare type Responsive<V, T extends {
    breakpoints?: any;
}> = V | Array<V | null> | {
 ...
 * // => Result: "sm" | "md"
 */
export declare type Scale<K extends keyof T, T> = T[K] extends any[] ? number : T[K] extends Record<infer U, any> ? U : T[K] extends ThemeKey<infer V> ? V : never;
export declare type StyleProps = SpaceProps & ColorProps & TypographyProps & FlexboxProps & GridProps & LayoutProps & BorderProps & ShadowProps & BackgroundProps & PositionProps & OutlineProps & OtherProps;
export declare type SystemProps = StyleProps & PseudoProps<StyleProps>;
export {};
