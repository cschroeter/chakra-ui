var shadows = {
    ...
    xl: "0 50px 100px 0 rgba(60,66,87, .12), 0 15px 35px 0 rgba(60,66,87, .12), 0 5px 15px 0 rgba(0,0,0, .12)",
    focusring: " 0 0 0 4px rgba(58,151,212, .28), 0 0 1px 1px rgba(7,89,150, .36)",
};
