...
var Popper_utils_1 = require("./Popper.utils");
...
function usePopper(props) {
    ...
    useSafeLayoutEffect(function () {
        if (referenceRef.current && popoverRef.current) {
            popper.current = core_1.createPopper(referenceRef.current, popoverRef.current, {
                placement: originalPlacement,
                strategy: fixed ? "fixed" : "absolute",
                modifiers: tslib_1.__spreadArrays([
                    {
                        name: "eventListener",
                        phase: "write",
    ...
    var computedArrowStyles = tslib_1.__assign(tslib_1.__assign({}, arrowStyles), Popper_utils_1.getArrowStyles(placement, arrowSize));
    return {
